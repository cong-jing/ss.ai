...
export type PromptViewModel = {
    p1: {
        /**
         * Generated speaker tag for self actor, e.g. "p1[诗诗]".
         * Source: runtime alias generator from conversation_actors rows.
         */
        speakerTag: string;
        /**
         * Character display name shown in prompt.
         * Source: characters.display_name fallback to characters.name.
         */
        displayName: string;
        /**
         * Character description for role grounding.
         * Source: characters.description.
         */
        description: string;
        /**
         * Character persona prompt.
         * Source: characters.persona_prompt.
         */
        personaPrompt: string;
    };
    p2: {
        /**
         * P2 is reserved for system actor by convention.
         * Kept as explicit constant marker; no actor payload is required.
         */
        speakerTag: "p2[system]";
    };
    actors: Array<{
        /**
         * Generated speaker tag for loop actors (starts from p3).
         * Source: runtime alias generator from conversation_actors rows.
         */
        speakerTag: string;
        /**
         * Actor display name.
         * Source: conversation_actors.display_name.
         */
        displayName: string;
        /**
         * Actor source type constrained to prompt-loop participants.
         * Source: conversation_actors.source_type.
         */
        sourceType: PromptLoopActorSourceType;
        /**
         * Normalized profile text used by template without branching.
         * Source: conversation_actors.profile_snapshot_json and user_profiles.bio fallback.
         */
        profile: string;
    }>;
...
export function buildPromptViewModel(input: BuildPromptViewModelInput): PromptViewModel {
    ...
    const actors = speakerTags.map(item => {
        ...
        // p1 is always self and p2 is always system; loop starts from p3 (other actors only).
        if (actor.role !== "other") {
            return null;
        }
